...
%Of course in many situations an LDL factorization might be faster, but having both options available enables.

\hinder{importance of boundedness of dual multipliers for Cholesky factorization to be numerically stable, instability of LDL}
...
\hinder{commentary - we check for feasibility before accepting steps, this means we almost always accept the step!}
